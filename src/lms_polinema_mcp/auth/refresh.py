        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                try:
                    ...
                    # Button may redirect in the current page rather than opening a new tab
                    try:
                        connect_btn = (
                            page.locator("a, button")
                            .filter(has_text="Connect to LMS Polinema")
                            .first
                        )
                        connect_btn.click()
                ...
                # If MoodleSession was not immediately captured, navigate to Moodle directly
